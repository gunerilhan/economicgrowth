---
title: "EC569 Economic Growth <br>  The Solow Growth Model <br> Lecture 2"
...
Notice that next periods capital per worker is approximately equal to current capital per worker plus change in capital per worker
$$ k(1) \approx k(0) + \dot{k}(0) = 1 + .14 = 1.14 $$
$$ y(1) = f(k(1))=1.14^{1/3} \approx 1.04 $$
...
---
### Income increase after an increase in investment rate

<center>
<img src="./files/income_time.jpg" width="60%"/>
</center>
Source: Weil (2013)
...
- Learn quantitative predictions of the Solow model

- Compare model predictions with the data
