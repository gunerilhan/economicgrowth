...
In equilibrium, return to spending one more hour on innovation 

 - is equal to return on working one more hour in the production sector (wage rate)
...
- In both models, long-run **growth** is independent of the fraction of labor force engaging in research
 ...
 - Remember: $\dot{A} = \frac{(\gamma_AL)^\lambda}{\mu}A^\phi$, and assume $\phi<1$
...
<iframe src="./files/tweet.html" width="90%" height="490" frameborder="0" scrolling="no" title="NPR embedded audio player"></iframe>
]
